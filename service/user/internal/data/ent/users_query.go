...
func (uq *UsersQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (uq *UsersQuery) FirstIDX(ctx context.Context) int64 {
...
func (uq *UsersQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (uq *UsersQuery) OnlyIDX(ctx context.Context) int64 {
...
func (uq *UsersQuery) IDs(ctx context.Context) ([]int64, error) {
	var ids []int64
...
func (uq *UsersQuery) IDsX(ctx context.Context) []int64 {
	ids, err := uq.IDs(ctx)
	if err != nil {
		panic(err)
	}
