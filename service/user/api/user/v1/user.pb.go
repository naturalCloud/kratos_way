...
func (x *CreateUserReply) GetBirthday() string {
	if x != nil {
		return x.Birthday
	}
	return ""
...
var file_user_v1_user_proto_rawDesc = []byte{
	...
	0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x32, 0xe1, 0x01, 0x0a,
	...
	0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x41, 0x0a,
...
var file_user_v1_user_proto_depIdxs = []int32{
	...
	4, // 2: api.user.v1.User.GetUser:input_type -> api.user.v1.GetUserRequest
	1, // 3: api.user.v1.User.CreateUser:output_type -> api.user.v1.CreateUserReply
	3, // 4: api.user.v1.User.UpdateUser:output_type -> api.user.v1.UpdateUserReply
	5, // 5: api.user.v1.User.GetUser:output_type -> api.user.v1.GetUserReply
